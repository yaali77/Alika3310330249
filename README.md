...
- تولید سیگنال‌های خرید و فروش بر اساس ترکیب تحلیل‌ها
- تحلیل تکنیکال و بنیادی برای صنایع و نمادها
- تحلیل خبرها برای بورس ایران و بازارهای جهانی
...
### برنامه‌ی توسعه (Roadmap)
- افزودن ماژول سیگنال‌دهی خرید/فروش با قوانین قابل پیکربندی
- اضافه‌کردن تحلیل بنیادی (صورت‌های مالی، نسبت‌های کلیدی، رشد سود)
- پردازش و امتیازدهی اخبار فارسی و انگلیسی برای بورس ایران و جهان
